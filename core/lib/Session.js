...
class Session extends eventUtils_1.TypedEventEmitter {
    ...
    getConfiguration() {
        ...
        const { string: userAgentString, operatingSystemName, operatingSystemVersion: osVersion, uaClientHintsPlatformVersion, browserVersion, browserName, } = this.emulationProfile.userAgentOption ?? {};
